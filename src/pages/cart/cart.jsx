...
import { clearCart, deleteStack, plusPizza, minusPizza } from '../../store/actions/setCart'
import { CartItem, EmptyCart } from './components'

const Cart = () => {
	const dispatch = useDispatch()
	const { totalPrice, totalCount, pizzasInCart } = useSelector(state => ({
	...
	const addPizzaToStack = (id) => {
		dispatch(plusPizza(id))
	}

	const deletePizzaFromStack = (id) => {
				...
				? <div class="cart">
					<div class="cart__top">
						<h2 class="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
							...
							Корзина</h2>
						<div onClick={onClearCartClick} class="cart__clear">
					...
					<div class="content__items">
						{Object.values(pizzasInCart).map((arr, index) => <CartItem
					...
					<div class="cart__bottom">
						...
						<div class="cart__bottom-buttons">
							<Link to="/pizza" class="button button--outline button--add go-back-btn">
